...
<div class="u-right u-rel u-clearFix">
  <a href='../index.php' class='btn btn--nav showOnPort'>
...
<div class="header__subNav u-clearFix">
  <div class='header__subNavTitle u-left'>
    <h1 class='title--h1 header__title' id='mainTitle'>My lists</h1>
    <span class='title--h1-plus'></span>
  </div>
  <ul class='header__breadcrumb $hide'>
    ...
    <li class='header__breadcrumb-item'>
      <a href='javascript:;' class='btn btn--breadcrumb btn--fadeText'>My lists</a>
    </li>
  </ul>
</div> 
</div> 
